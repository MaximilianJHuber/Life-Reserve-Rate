...
The historical rates are in the [CSV file](./ref_rate.csv) and current rates are published by the [NAIC](https://content.naic.org/research_moody.htm). If anyone knows the February 2021 rate, please open an issue or send a pull request, since the [Wayback Machine](https://web.archive.org/web/*/https://content.naic.org/research_moody.htm) missed that month's rate.
